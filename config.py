...
def arg():
    ...
    # Encoding
    parser.add_argument('--encoding', default='cp949', help="windows:cp949, else: utf-8")

    # Mode
    parser.add_argument('--mode', default="train",
                        choices=['test', 'debug'])  # NOTE: test 코드 만들어야 함.
    parser.add_argument('--pretrained_path', help="example: ./result/bicycle/test/1/checkpoint/200.tar")
    parser.add_argument('--train_cont_path', help="example: ./result/bicycle/test/1/checkpoint/200.tar")
    # Net
    parser.add_argument('--net', type=str, default = "LSTM", help='Please enter your name of net.')

    # Data
    parser.add_argument('--dataset', default='public_bicycle')
    ...
    parser.add_argument('--label', type=str, default="0,1,2", help='Please enter the possible label')
    ...
    parser.add_argument('--scheduler', '-sch', type = str, default = "exp")
    ...
    parser.add_argument('--extractor', default="LSTM")
